...
<div class="tool">
    ...
    <div>
        <div class="thank">즐겨찾기 완료</div><br><br>
        <div>${entName } 즐겨찾기가 완료되었습니다</div><br>
        <a class="menus" class="menus" href="${path }/Hire/HireHome.do?memNo=${commonLogin.memNo}"> <div>메인으로 이동</div></a><br>
        <a class="menus" href="${path }/Hire/HireFavorites.do?memNo=${commonLogin.memNo}" class="myHire1" ><div>내 즐겨찾기 보러가기</div></a><br>
    </div><br><br>
    <div>안내사항</div><br><br>
    <div class="info">
