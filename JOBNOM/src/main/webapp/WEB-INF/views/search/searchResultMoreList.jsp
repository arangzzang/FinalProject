                                    ...
                                    <div class="content_wrap">
                                        ...
                                        <dl class="content_col2_3 cominfo">
                                            <dt class="us_titb_13">
                                                ...
                                                <c:if test="${empty commonLogin && not fn:contains(entFollow[status.index].ENT_NO, list.ENT_NO)}">
                                                <button class="btn_heart1" id="hart">
                                                    <i class="far fa-heart"></i>
                                                </button>
                                              	</c:if>
                                              	 <c:if test="${empty commonLogin && fn:contains(entFollow[status.index].ENT_NO, list.ENT_NO)}">
