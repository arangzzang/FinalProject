				...
				<div class="result_unit">
					<div class="result_unit_con">
						...
						<div class="result_unit_info">
							<div class="unit_head">
								<a class="posting_name" href="#"onclick="location.href = '${path }/Hire/announcementPageFirst?recNo=${list2.REC_NO}&anoNum=${list2.REC_CATEGORY }&memNo=${commonLogin.memNo }'"> ${list2.REC_TITLE } </a> 
